...
\begin{equation}
\begin{aligned}
{\rm E}_{x, y} \left( x - {\rm E}_x (x | y) + {\rm E}_x (x | y) - {\rm E} x \right) ^ 2
=& {\rm E}_{x, y} \left( x - {\rm E}_x (x | y) \right) ^ 2 \\
&+ 2 {\rm E}_{x, y} \left( \left( x - {\rm E}_x (x | y) \right) \left( {\rm E}_x (x | y) - {\rm E} x \right) \right) \\
&+ {\rm E}_y \left( {\rm E}_x (x | y) - {\rm E} x \right) ^ 2
\end{aligned}
\end{equation}
%
...
%
\begin{equation}
2 {\rm E}_y \left( \left( {\rm E}_x (x | y) - {\rm E} x \right) {\rm E}_x \left( x - {\rm E}_x (x | y) \right) \right) = - 2 {\rm E}_y \left( {\rm E}_x (x | y) - {\rm E} x \right) ^ 2
\end{equation}
%
