...
%
\begin{equation}
\int_0^1 \mu_1 ^ {\alpha_1 - 1} \mu_2 ^ {\alpha_2 - 1} d\mu = \frac{\Gamma(\alpha_1) \Gamma(\alpha_2)}{\Gamma(\alpha_1 + \alpha_2)},
\end{equation}
%
where
%
...
%
\begin{equation}
\int \prod_{k = 1}^{K} \mu_k ^ {\alpha_k - 1} d\bm{\mu} = \frac{\prod_{k = 1}^{K} \Gamma(\alpha_k)}{\Gamma \left( \sum_{k = 1}^{K} \alpha_k \right)},
\end{equation}
%
where
%
...
\end{equation}
%
Let $\bm{\mu}$ be a vector of $K + 1$ elements such that
%
\begin{equation}
\sum_{k = 1}^{K + 1} \mu_k = 1.
\end{equation}
...
%
\begin{equation}
\int \prod_{k = 1}^{K + 1} \mu_k ^ {\alpha_k - 1} d\bm{\mu} 
= \int \mu_{K + 1} ^ {\alpha_{K + 1} - 1} \left( \int \prod_{k = 1}^{K} {\mu'_k} ^ {\alpha_k - 1} d\bm{\mu}' \right) d\mu_{K + 1}.
\end{equation}
%
where $\bm{\mu}'$ is the vector of the first $K$ elements of $\bm{\mu}$.
By the transformation 
%
\begin{equation}
\bm{\mu}'' = \frac{1}{1 - \mu_{K + 1}} \bm{\mu}',
\end{equation}
%
the right hand side can be written as
%
\begin{equation}
\begin{aligned}
&\int \mu_{K + 1} ^ {\alpha_{K + 1} - 1} \left( \int \left( \prod_{k = 1}^{K} \left( (1 - \mu_{K + 1}){\mu''_k} \right) ^ {\alpha_k - 1} \right) (1 - \mu_{K + 1}) ^ K d\bm{\mu}'' \right) d\mu_{K + 1} \\
&= \int \mu_{K + 1} ^ {\alpha_{K + 1} - 1} (1 - \mu_{K + 1}) ^ {\Sigma_{k = 1}^{K} \alpha_k} \left( \int \prod_{k = 1}^{K} {\mu''_k} ^ {\alpha_k - 1} d\bm{\mu}'' \right) d\mu_{K + 1}.
\end{aligned}
\end{equation}
%
Since
...
\end{equation}
%
the assumption can be used to write the right hand as
%
\begin{equation}
\frac{\prod_{k = 1}^{K} \Gamma(\alpha_k)}{\Gamma \left( \sum_{k = 1}^{K} \alpha_k \right)} \frac{\Gamma(\alpha_{K + 1}) \Gamma \left( \sum_{k = 1}^{K} \alpha_k + 1 \right)}{\Gamma \left( \sum_{k = 1}^{K + 1} \alpha_k + 1 \right)}
= \frac{\sum_{k = 1}^{K} \alpha_k}{\sum_{k = 1}^{K + 1} \alpha_k} \frac{\prod_{k = 1}^{K + 1} \Gamma(\alpha_k)}{\Gamma \left( \sum_{k = 1}^{K + 1} \alpha_k \right)}.
\end{equation}
%
Therefore,
%
\begin{equation}
\int \prod_{k = 1}^{K + 1} \mu_k ^ {\alpha_k - 1} d\bm{\mu} = \frac{\prod_{k = 1}^{K + 1} \Gamma(\alpha_k)}{\Gamma \left( \sum_{k = 1}^{K + 1} \alpha_k \right)}.
\end{equation}
%
Thus, the assumption is proved by induction on $K$.
