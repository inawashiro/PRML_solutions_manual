...
\subsection{(Incomplete)}
\label{2.18}
Let $\bm{\Sigma}$ be a real symmetric matrix such that
%
\begin{equation}
\bm{\Sigma} \mathbf{u}_i = \lambda_i \mathbf{u}_i. 
\end{equation}
%
Taking the complex conjugate of both sides and subtracting the original equation 
%
\begin{equation}
\bm{\Sigma} \left( \overline{\mathbf{u}_i} - \mathbf{u}_i \right)
= \overline{\lambda_i} \overline{\mathbf{u}_i} - \lambda_i \mathbf{u}_i.
\end{equation}
%
Taking the inner product with $\mathbf{u}_i$ of both sides gives
%
\begin{equation}
\mathbf{u}_i ^ \intercal \bm{\Sigma} \overline{\mathbf{u}_i} 
- \mathbf{u}_i ^ \intercal \bm{\Sigma} \mathbf{u}_i
= \overline{\lambda_i} - \mathbf{u}_i ^ \intercal \lambda_i \mathbf{u}_i.
\end{equation}
%
...
\begin{aligned}
\lambda_i
&= \overline{\mathbf{u}_i} ^ \intercal \lambda_i \mathbf{u}_i \\
...
\begin{equation}
\begin{aligned}
\lambda_j \mathbf{u}_i ^ \intercal \mathbf{u}_j
&= \mathbf{u}_i ^ \intercal \lambda_j \mathbf{u}_j \\
&= \mathbf{u}_i ^ \intercal \bm{\Sigma} \mathbf{u}_j \\
&= \mathbf{u}_i ^ \intercal \bm{\Sigma} ^ \intercal \mathbf{u}_j \\
&= (\bm{\Sigma} \mathbf{u}_i) ^ \intercal \mathbf{u}_j \\
&= \lambda_i \mathbf{u}_i ^ \intercal \mathbf{u}_j.
\end{aligned}
\end{equation}
%
