...
&+ \mathbf{w}_1 ^ \intercal \left( \int \mathbf{x} p(\mathbf{x}) d\mathbf{x} - \bm{\mu} \right)
+ \mathbf{w}_2 ^ \intercal \left( \int (\mathbf{x} - \bm{\mu}) (\mathbf{x} - \bm{\mu}) ^ \intercal p(\mathbf{x}) d\mathbf{x} - \bm{\Sigma} \right) \mathbf{w}_2.
\end{aligned}
\end{equation}
%
Then
...
= - \ln p(\mathbf{x}) - 1 
+ \lambda
+ \mathbf{w}_1 ^ \intercal \mathbf{x} 
+ \mathbf{w}_2 ^ \intercal (\mathbf{x} - \bm{\mu}) (\mathbf{x} - \bm{\mu}) ^ \intercal \mathbf{w}_2.
\end{equation}
%
...
- 1 
+ \lambda
- \mathbf{w}_1 ^ \intercal \left( \mathbf{w}_2 \mathbf{w}_2 ^ \intercal \right) ^ {- 1} \mathbf{w}_1
+ \left( \mathbf{x} - \bm{\mu} - \left( \mathbf{w}_2 \mathbf{w}_2 ^ \intercal \right) ^ {- 1} \mathbf{w}_1\right) ^ \intercal \left( \mathbf{w}_2 \mathbf{w}_2 ^ \intercal \right) \left( \mathbf{x} - \bm{\mu} - \left( \mathbf{w}_2 \mathbf{w}_2 ^ \intercal \right) ^ {- 1} \mathbf{w}_1\right).
\right).
\end{equation}
%
Substituting it to 
...
%
\begin{equation}
\mathbf{y} = \sqrt{- \lambda_3} \left( \mathbf{x} - \left( 1 - \frac{\lambda_2}{2 \lambda_3} \right) \bm{\mu} \right)
\end{equation}
%
gives
%
...
\int \exp \left( - \mathbf{y} ^ \intercal \mathbf{y} \right) (- \lambda_3) ^ {- \frac{1}{2}} d\mathbf{y} 
&= 1, \\
\exp \left( - 1 + \lambda_1 - \frac{\lambda_2 ^ 2}{4 \lambda_3 ^ 2} \norm{\bm{\mu}} ^ 2 \right) 
\int \left( \frac{\mathbf{y}}{\sqrt{- \lambda_3}} + \left( 1 - \frac{\lambda_2}{2 \lambda_3} \right) \bm{\mu} \right) \exp \left( - \mathbf{y} ^ \intercal \mathbf{y} \right) (- \lambda_3) ^ {- \frac{1}{2}} d\mathbf{y} 
&= \bm{\mu}, \\
\exp \left( - 1 + \lambda_1 - \frac{\lambda_2 ^ 2}{4 \lambda_3 ^ 2} \norm{\bm{\mu}} ^ 2 \right) 
\int \left( \frac{\mathbf{y}}{\sqrt{- \lambda_3}} - \frac{\lambda_2}{2 \lambda_3} \bm{\mu} \right) \left( \frac{\mathbf{y}}{\sqrt{- \lambda_3}} - \frac{\lambda_2}{2 \lambda_3} \bm{\mu} \right) ^ \intercal \exp \left( - \mathbf{y} ^ \intercal \mathbf{y} \right) (- \lambda_3) ^ {- \frac{1}{2}} d\mathbf{y} 
&= \bm{\Sigma}.
\end{aligned}
\end{equation}
%
...
&= 1, \\
\exp \left( - 1 + \lambda_1 - \frac{\lambda_2 ^ 2}{4 \lambda_3 ^ 2} \norm{\bm{\mu}} ^ 2 \right)
\left( 1 - \frac{\lambda_2}{2 \lambda_3} \right) 
(- \lambda_3) ^ {- \frac{1}{2}}
\left( \Gamma \left( \frac{1}{2} \right) \right) ^ D 
\bm{\mu}
&= \bm{\mu}, \\
\exp \left( - 1 + \lambda_1 - \frac{\lambda_2 ^ 2}{4 \lambda_3 ^ 2} \norm{\bm{\mu}} ^ 2 \right)
(- \lambda_3) ^ {- \frac{1}{2}}
\left( - \frac{1}{\lambda_3} \Gamma \left( \frac{3}{2} \right) \left( \Gamma \left( \frac{1}{2} \right) \right) ^ {D - 1} \mathbf{I} 
+ \frac{\lambda_2 ^ 2}{4 \lambda_3 ^ 2} \bm{\mu} \bm{\mu} ^ \intercal \right) 
&= \bm{\Sigma}. 
\end{aligned}
\end{equation}
%
