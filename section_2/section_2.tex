...
\begin{equation}
\begin{aligned}
&{\rm E} \left( x - {\rm E} (x | y) + {\rm E} (x | y) - {\rm E} x \right) ^ 2 \\
&= {\rm E} \left( x - {\rm E} (x | y) \right) ^ 2 + 2 {\rm E} \left( \left( x - {\rm E} (x | y) \right) \left( {\rm E} (x | y) - {\rm E} x \right) \right) + {\rm E} \left( {\rm E} (x | y) - {\rm E} x \right) ^ 2
\end{aligned}
\end{equation}
%
By the definition, the first term of the right hand side can be written as ${\rm E}_y \left( {\rm var}_x (x | y) \right)$.
By the result above, the third term of the right hand side can be written as
%
\begin{equation}
