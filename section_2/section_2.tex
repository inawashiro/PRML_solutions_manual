...
\begin{aligned}
\int_{- \infty}^{\infty}
\frac{(\tau_1 \tau_2) ^ \frac{1}{2}}{2 \pi} 
&\exp \left( 
- \frac{\tau_1 + \tau_2}{2} \left( x_2 - \frac{\tau_1 (x - \mu_1) + \tau_2 \mu_2}{\tau_1 + \tau_2} \right) ^ 2
\right) 
dx_2
\\
&\exp \left( 
...
\begin{equation}
\mathbf{I}
= (\mathbf{A} + \mathbf{B} \mathbf{C} \mathbf{D}) \left( \mathbf{A} ^ {- 1} - \mathbf{A} ^ {- 1} \mathbf{B} \mathbf{C} \mathbf{D} \mathbf{A} ^ {- 1} \right) 
+ \left( \mathbf{B} \mathbf{C} \mathbf{D} \mathbf{A} ^ {- 1} \right) ^ 2.
\end{equation}
%
%
\begin{equation}
\begin{aligned}
\mathbf{I}
= \left( \mathbf{C} ^ {- 1} + \mathbf{D} \mathbf{A} ^ {- 1} \mathbf{B} \right) 
\left( \mathbf{C} - \mathbf{C} \mathbf{D} \mathbf{A} ^ {- 1} \mathbf{B} \mathbf{C} \right) + \left( \mathbf{D} \mathbf{A} ^ {- 1} \mathbf{B} \mathbf{C} \right) ^ 2.
\end{aligned}
\end{equation}
%
...
\begin{aligned}
p(\mathbf{x}) 
&= \mathcal{N} \left( \mathbf{x} | \bm{\mu}_{\mathbf{x}}, \bm{\Sigma}_{\mathbf{x}} \right), \\
p(\mathbf{z}) 
&= \mathcal{N} \left( \mathbf{z} | \bm{\mu}_{\mathbf{z}}, \bm{\Sigma}_{\mathbf{z}} \right).
\end{aligned}
\end{equation}
%
Then
...
\begin{equation}
\int 
	\mathcal{N} \left( \mathbf{y} | \mathbf{x} + \bm{\mu}_{\mathbf{z}}, \bm{\Sigma}_{\mathbf{z}} \right) 
	\mathcal{N} \left( \mathbf{x} | \bm{\mu}_{\mathbf{x}}, \bm{\Sigma}_{\mathbf{x}} \right) 
	d\mathbf{x}.
\end{equation}
%
The logarithm of the integrand is given by
%
\begin{equation}
- \frac{1}{2} 
\left( 
...
\]
%
Therefore, the logarithm of the integrand except the constant can be written as
%
\begin{equation}
-\frac{1}{2}
\left( 
...
%%
%\begin{equation}
%\int \mathcal{N} \left( \mathbf{y} | \mathbf{x} + \bm{\mu}_{\mathbf{z}}, \bm{\Sigma}_{\mathbf{z}} \right) \mathcal{N} \left( \mathbf{x} | \bm{\mu}_{\mathbf{x}}, \bm{\Sigma}_{\mathbf{x}} \right) d\mathbf{x}.
%\end{equation}
%%
%Since
%%
%\begin{equation}
%\begin{aligned}
%&- \frac{1}{2} \left( \mathbf{y} - \mathbf{x} - \bm{\mu}_{\mathbf{z}} \right) ^ \intercal \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \left( \mathbf{y} - \mathbf{x} - \bm{\mu}_{\mathbf{z}} \right) \\
%&= - \frac{1}{2} \left( \mathbf{y} - \bm{\mu}_{\mathbf{x}} - \bm{\mu}_{\mathbf{z}} - \left( \mathbf{x} - \bm{\mu}_{\mathbf{x}} \right) \right) ^ \intercal \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \left( \mathbf{y} - \bm{\mu}_{\mathbf{x}} - \bm{\mu}_{\mathbf{z}} - \left( \mathbf{x} - \bm{\mu}_{\mathbf{x}} \right) \right),
%\end{aligned}
%\end{equation}
%%
%we have
...
%\begin{aligned}
%&- \frac{1}{2} \left( \mathbf{y} - \mathbf{x} - \bm{\mu}_{\mathbf{z}} \right) ^ \intercal \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \left( \mathbf{y} - \mathbf{x} - \bm{\mu}_{\mathbf{z}} \right)
%- \frac{1}{2} (\mathbf{x} - \bm{\mu}_{\mathbf{x}}) ^ \intercal \bm{\Sigma}_{\mathbf{x}} ^ {- 1} (\mathbf{x} - \bm{\mu}_{\mathbf{x}}) \\
%=& - \frac{1}{2} \left( \mathbf{y} - \bm{\mu}_{\mathbf{x}} - \bm{\mu}_{\mathbf{z}} \right) ^ \intercal \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \left( \mathbf{y} - \bm{\mu}_{\mathbf{x}} - \bm{\mu}_{\mathbf{z}} \right) \\
%&- \left( \mathbf{y} - \bm{\mu}_{\mathbf{x}} - \bm{\mu}_{\mathbf{z}} \right) ^ \intercal \bm{\Sigma}_{\mathbf{z}} ^ {- 1} (\mathbf{x} - \bm{\mu}_{\mathbf{x}}) \\
%&- \frac{1}{2} (\mathbf{x} - \bm{\mu}_{\mathbf{x}}) ^ \intercal \left( \bm{\Sigma}_{\mathbf{x}} ^ {- 1} + \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \right) (\mathbf{x} - \bm{\mu}_{\mathbf{x}}).
%\end{aligned}
%\end{equation}
%%
%The right hand side can be written as
...
%\begin{aligned}
%&- \frac{1}{2} \left( \mathbf{y} - \bm{\mu}_{\mathbf{x}} - \bm{\mu}_{\mathbf{z}} \right) ^ \intercal \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \left( \mathbf{y} - \bm{\mu}_{\mathbf{x}} - \bm{\mu}_{\mathbf{z}} \right) \\
%&+ \frac{1}{2} \left( \left( \bm{\Sigma}_{\mathbf{x}} ^ {- 1} + \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \right) ^ {- 1} \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \left( \mathbf{y} - \bm{\mu}_{\mathbf{x}} - \bm{\mu}_{\mathbf{z}} \right) \right) ^ \intercal \left( \bm{\Sigma}_{\mathbf{x}} ^ {- 1} + \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \right) \left( \left( \bm{\Sigma}_{\mathbf{x}} ^ {- 1} + \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \right) ^ {- 1} \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \left( \mathbf{y} - \bm{\mu}_{\mathbf{x}} - \bm{\mu}_{\mathbf{z}} \right) \right) \\
%&- \frac{1}{2} \left( \mathbf{x} - \bm{\mu}_{\mathbf{x}} - \left( \bm{\Sigma}_{\mathbf{x}} ^ {- 1} + \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \right) ^ {- 1} \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \left( \mathbf{y} - \bm{\mu}_{\mathbf{x}} - \bm{\mu}_{\mathbf{z}} \right) \right) ^ \intercal \left( \bm{\Sigma}_{\mathbf{x}} ^ {- 1} + \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \right) \left( \mathbf{x} - \bm{\mu}_{\mathbf{x}} - \left( \bm{\Sigma}_{\mathbf{x}} ^ {- 1} + \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \right) ^ {- 1} \bm{\Sigma}_{\mathbf{z}} ^ {- 1} \left( \mathbf{y} - \bm{\mu}_{\mathbf{x}} - \bm{\mu}_{\mathbf{z}} \right) \right).
%\end{aligned}
%\end{equation}
%%
%The firtst term of the right hand side can be written as
%%
%\begin{equation}
%- \frac{1}{2} 
%\left( 
...
%\end{equation}
%%
%Since $\bm{\Sigma}_{\mathbf{x}}$ and  $\bm{\Sigma}_{\mathbf{z}}$ are symmetric, the second term can be written as
%%
%\begin{equation}
%\frac{1}{2} 
%\left( 
