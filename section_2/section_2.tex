...
= (2 \pi) ^ {- \frac{D}{2}} (\det \bm{\Sigma}) ^ {- \frac{1}{2}} \exp \left( - \frac{1}{2} (\mathbf{x} - \bm{\mu}) ^ \intercal (\mathbf{S} + \mathbf{A}) (\mathbf{x} - \bm{\mu})  \right).
\end{equation}
%
By above,
%
...
\begin{equation}
\mathcal{N} (\mathbf{x} | \bm{\mu}, \bm{\Sigma}) 
= (2 \pi) ^ {- \frac{D}{2}} (\det \bm{\Sigma}) ^ {- \frac{1}{2}} \exp \left( - \frac{1}{2} (\mathbf{x} - \bm{\mu}) ^ \intercal \mathbf{S} (\mathbf{x} - \bm{\mu}) \right).
\end{equation}
%
