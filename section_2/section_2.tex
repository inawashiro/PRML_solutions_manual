...
&= \int_{- \infty}^{\infty} \frac{\tau_1}{2 \pi} \exp \left( - \frac{\tau_1}{2} (x - \mu_1 - x_2) ^ 2 \right) \frac{\tau_2}{2 \pi} \exp \left( - \frac{\tau_2}{2} (x_2 - \mu_2) ^ 2 \right) dx_2.
\end{aligned}
\end{equation}
%
Since the integrand in the right hand side can be written as
%
\begin{equation}
\begin{aligned}
&\frac{\tau_1 \tau_2}{4 \pi ^ 2} 
\exp \left( 
- \frac{\tau_1 + \tau_2}{2} 
\left( x_2 - \frac{\tau_1 (x - \mu_1) + \tau_2 \mu_2}{\tau_1 + \tau_2} \right) ^ 2 
\right)
\exp \left( \frac{\tau_1 + \tau_2}{2} \left( \frac{\tau_1 (x - \mu_1) + \tau_2 \mu_2}{\tau_1 + \tau_2} \right) ^ 2\right) \\
&\propto
\exp \left( 
\frac{1}{2} \frac{\tau_1 ^ 2}{\tau_ 1 + \tau_2} \left( x - \left( \mu_1 - \frac{\tau_2}{\tau_1} \mu_2 \right) \right) ^ 2
\right),
\end{aligned}
\end{equation}
%
...
%
\begin{equation}
p(x) = \mathcal{N} \left( x \left| \mu_1 - \frac{\tau_2}{\tau_1} \mu_2, \left( 1 + \frac{\tau_2}{\tau_1} \right) \tau_1 ^ {- 1} \right. \right).
\end{equation}
%
