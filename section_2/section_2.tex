...
\end{equation}
%
Taking the complex conjugate of both sides and subtracting the original equation gives
%
\begin{equation}
...
%
\begin{equation}
\mathbf{u}_i ^ \intercal \bm{\Sigma} \left( \overline{\mathbf{u}_i} - \mathbf{u}_i \right)
= \mathbf{u}_i ^ \intercal \left( \overline{\lambda_i} \overline{\mathbf{u}_i} - \lambda_i \mathbf{u}_i \right).
\end{equation}
%
