...
\end{equation}
%
By the symmetry, the first term of the right hand side can be written as $0$.
By the definition, the second term of the right hand side can be written as $\bm{\mu}$
Therefore,
%
\begin{equation}
{\rm E} \mathbf{x}
...
\end{equation}
%
with respect to $\bm{\Lambda}$ gives
%
\begin{equation}
\begin{aligned}
&
\frac{{(\bm{\Lambda} ^ {- 1})} ^ \intercal}{2}
\int
{\rm St}(\mathbf{x} | \bm{\mu}, \bm{\Lambda}, \nu)
d\mathbf{x} \\
&
...
\end{equation}
%
The first term of the left hand side can be written as $\frac{\bm{\Lambda} ^ {- 1}}{2}$.
Since
%
\begin{equation}
\left(
...
\frac{\Gamma(\frac{D + \nu}{2})}{\Gamma (\frac{\nu}{2})}
\frac{(\det \bm{\Lambda}) ^ \frac{1}{2}}{(\pi \nu) ^ \frac{D}{2}}
\frac{(\bm{\Lambda} + \bm{\Lambda} ^ \intercal) (\mathbf{x} - \bm{\mu})}{\nu}
\left(
	-
	\frac{D + \nu}{2}
\right)
...
\left(
	-
	\frac{1}{2}
	(\mathbf{x} - \bm{\mu}) ^ \intercal \Lambda (\mathbf{x} - \bm{\mu})
\right).
\end{equation}
%
