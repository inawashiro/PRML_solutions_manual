...
%
\begin{equation}
\int \prod_{k = 1}^{M} \mu_k ^ {\alpha_k - 1} d\bm{\mu} = \frac{\prod_{k = 1}^{M} \Gamma(\alpha_k)}{\Gamma \left( \sum_{k = 1}^{M} \alpha_k \right)},
\end{equation}
%
where
%
...
\end{equation}
%
Let $\bm{\mu}$ be a vector of $M + 1$ elements such that
%
\begin{equation}
\sum_{k = 1}^{M + 1} \mu_k = 1.
\end{equation}
...
%
\begin{equation}
\int \prod_{k = 1}^{M + 1} \mu_k ^ {\alpha_k - 1} d\bm{\mu} 
= \int \mu_{M + 1} ^ {\alpha_{M + 1} - 1} \left( \int \prod_{k = 1}^{M} {\mu'_k} ^ {\alpha_k - 1} d\bm{\mu}' \right) d\mu_{M + 1}.
\end{equation}
%
...
\begin{equation}
\begin{aligned}
&\int \mu_{M + 1} ^ {\alpha_{M + 1} - 1} \left( \int \left( \prod_{k = 1}^{M} \left( (1 - \mu_{M + 1}){\mu''_k} \right) ^ {\alpha_k - 1} \right) (1 - \mu_{M + 1}) ^ M d\bm{\mu}'' \right) d\mu_{M + 1} \\
&= \int \mu_{M + 1} ^ {\alpha_{M + 1} - 1} (1 - \mu_{M + 1}) ^ {\Sigma_{k = 1}^{M} \alpha_k} \left( \int \prod_{k = 1}^{M} {\mu''_k} ^ {\alpha_k - 1} d\bm{\mu}'' \right) d\mu_{M + 1}.
\end{aligned}
\end{equation}
%
Since
