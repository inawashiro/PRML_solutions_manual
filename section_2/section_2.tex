...
= \int_{(\mathbf{x} - \bm{\mu}) ^ \intercal \mathbf{U} \bm{\Lambda} ^ {- 1} \mathbf{U} ^ \intercal  (\mathbf{x} - \bm{\mu}) = \Delta} d\mathbf{x}.
\end{equation}
%
By the transformation
%
\begin{equation}
\mathbf{y}
= \mathbf{U} ^ \intercal  (\mathbf{x} - \bm{\mu})
\end{equation}
%
and the property
%
...
%
\begin{equation}
\int_{\mathbf{y} ^ \intercal \bm{\Sigma} ^ {- 1} \mathbf{y} = \Delta} \abs{\det \mathbf{U}} d\mathbf{y}
= \int_{\mathbf{y} ^ \intercal \bm{\Sigma} ^ {- 1} \mathbf{y} = \Delta} d\mathbf{y}.
\end{equation}
%
Therefore,
%
