...
\begin{equation}
\begin{aligned}
\exp \left( - 1 + \lambda_1 - \frac{\lambda_2 ^ 2}{4 \lambda_3 ^ 2} \norm{\bm{\mu}} ^ 2 \right) \int \exp \left( \lambda_3 \left( \mathbf{x} - \left( 1 + \frac{\lambda_2}{2 \lambda_3} \right) \bm{\mu} \right) ^ \intercal \left( \mathbf{x} - \left( 1 + \frac{\lambda_2}{2 \lambda_3} \right) \bm{\mu} \right) \right) d\mathbf{x} &= 1, \\
\exp \left( - 1 + \lambda_1 - \frac{\lambda_2 ^ 2}{4 \lambda_3 ^ 2} \norm{\bm{\mu}} ^ 2 \right) \int \mathbf{x} \exp \left( \lambda_3 \left( \mathbf{x} - \left( 1 + \frac{\lambda_2}{2 \lambda_3} \right) \bm{\mu} \right) ^ \intercal \left( \mathbf{x} - \left( 1 + \frac{\lambda_2}{2 \lambda_3} \right) \bm{\mu} \right) \right) d\mathbf{x} &= \bm{\mu}, \\
\exp \left( - 1 + \lambda_1 - \frac{\lambda_2 ^ 2}{4 \lambda_3 ^ 2} \norm{\bm{\mu}} ^ 2 \right) \int (\mathbf{x} - \bm{\mu}) (\mathbf{x} - \bm{\mu}) ^ \intercal \exp \left( \lambda_3 \left( \mathbf{x} - \left( 1 + \frac{\lambda_2}{2 \lambda_3} \right) \bm{\mu} \right) ^ \intercal \left( \mathbf{x} - \left( 1 + \frac{\lambda_2}{2 \lambda_3} \right) \bm{\mu} \right) \right) d\mathbf{x} &= \bm{\Sigma}.
\end{aligned}
\end{equation}
%
%By the transformation
