...
\end{equation}
%
where $\bm{\mu}'$ is the vector of first $K$ elements of $\bm{\mu}$.
...
\begin{equation}
\begin{aligned}
&\int \mu_{K + 1} ^ {\alpha_{K + 1} - 1} \left( \int \prod_{k = 1}^{K} \left( (1 - \mu_{K + 1}){\mu''_k} \right) ^ {\alpha_k - 1} (1 - \mu_{K + 1}) ^ K d\bm{\mu}'' \right) d\mu_{K + 1} \\
...
%
\begin{equation}
\frac{\prod_{k = 1}^{K} \Gamma(\alpha_k)}{\Gamma \left( \sum_{k = 1}^{K} \alpha_k \right)} \frac{\Gamma(\alpha_{K + 1}) \Gamma \left( \sum_{k = 1}^{K} \alpha_k \right)}{\Gamma \left( \sum_{k = 1}^{K + 1} \alpha_k + 1 \right)}
= \frac{\prod_{k = 1}^{K + 1} \Gamma(\alpha_k)}{\Gamma \left( \sum_{k = 1}^{K + 1} \alpha_k + 1 \right)}.
\end{equation}
%
Therefore,
%
\begin{equation}
\int \prod_{k = 1}^{K + 1} \mu_k ^ {\alpha_k - 1} d\bm{\mu} = \frac{\prod_{k = 1}^{K + 1} \Gamma(\alpha_k)}{\Gamma \left( \sum_{k = 1}^{K + 1} \alpha_k + 1 \right)}.
\end{equation}
%
