...
\int \exp \left( - \mathbf{y} ^ \intercal \mathbf{y} \right) \frac{1}{\sqrt{- \lambda_3}} d\mathbf{y} 
&= 1, \\
\exp \left( - 1 + \lambda_1 - \frac{\lambda_2 ^ 2}{4 \lambda_3 ^ 2} \norm{\bm{\mu}} ^ 2 \right) 
\int \left( \frac{\mathbf{y}}{\sqrt{- \lambda_3}} + \left( 1 - \frac{\lambda_2}{2 \lambda_3} \right) \bm{\mu} \right) \exp \left( - \mathbf{y} ^ \intercal \mathbf{y} \right) \frac{1}{\sqrt{- \lambda_3}} d\mathbf{y} 
&= \bm{\mu}, \\
\exp \left( - 1 + \lambda_1 - \frac{\lambda_2 ^ 2}{4 \lambda_3 ^ 2} \norm{\bm{\mu}} ^ 2 \right) 
\int \left( \frac{\mathbf{y}}{\sqrt{- \lambda_3}} - \frac{\lambda_2}{2 \lambda_3} \bm{\mu} \right) \left( \frac{\mathbf{y}}{\sqrt{- \lambda_3}} - \frac{\lambda_2}{2 \lambda_3} \bm{\mu} \right) ^ \intercal \exp \left( - \mathbf{y} ^ \intercal \mathbf{y} \right) \frac{1}{\sqrt{- \lambda_3}} d\mathbf{y} 
&= \bm{\Sigma}.
\end{aligned}
\end{equation}
%
...
\begin{equation}
\begin{aligned}
\frac{1}{\sqrt{- \lambda_3}} \exp \left( - 1 + \lambda_1 - \frac{\lambda_2 ^ 2}{4 \lambda_3 ^ 2} \norm{\bm{\mu}} ^ 2 \right) 
\left( \Gamma \left( \frac{1}{2} \right) \right) ^ D 
&= 1, \\
\frac{1}{\sqrt{- \lambda_3}} \exp \left( - 1 + \lambda_1 - \frac{\lambda_2 ^ 2}{4 \lambda_3 ^ 2} \norm{\bm{\mu}} ^ 2 \right)
