...
\sum_{n = 1}^{N}
{\rm E}
(\mathbf{x}_n - \bm{\mu} + \bm{\mu} - \bm{\mu}_{\rm ML})
(\mathbf{x}_n - \bm{\mu} + \bm{\mu} - \bm{\mu}_{\rm ML}) ^ \intercal \\
=&
\frac{1}{N}
\sum_{n = 1}^{N}
{\rm E} (\mathbf{x}_n - \bm{\mu}) (\mathbf{x}_n - \bm{\mu}) ^ \intercal
+
\frac{1}{N}
\sum_{n = 1}^{N}
{\rm E} (\mathbf{x}_n - \bm{\mu}) (\bm{\mu} - \bm{\mu}_{\rm ML}) ^ \intercal \\
&+
\frac{1}{N}
\sum_{n = 1}^{N}
{\rm E} (\bm{\mu} - \bm{\mu}_{\rm ML}) (\mathbf{x}_n - \bm{\mu}) ^ \intercal
+
\frac{1}{N}
\sum_{n = 1}^{N}
{\rm E} (\bm{\mu} - \bm{\mu}_{\rm ML}) (\bm{\mu} - \bm{\mu}_{\rm ML}) ^ \intercal.
\end{aligned}
\end{equation}
%
Each term of the right hand side can be written as
%
\begin{equation}
\begin{aligned}
\frac{1}{N}
...
\frac{1}{N ^ 2}
\sum_{n = 1}^{N}
{\rm E} (\mathbf{x}_n - \bm{\mu}) \mathbf{x}_n ^ \intercal,
\\
\frac{1}{N}
\sum_{n = 1}^{N}
{\rm E}  
...
\frac{1}{N ^ 2}
\sum_{n = 1}^{N}
{\rm E} \mathbf{x}_n (\mathbf{x}_n - \bm{\mu}) ^ \intercal,
\\
\frac{1}{N}
\sum_{n = 1}^{N}
{\rm E}  
