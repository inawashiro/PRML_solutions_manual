...
%
\begin{equation}
\Var f(x) = \E \left( f(x) - \E f(x) \right) ^ 2.
\end{equation}
%
The right hand side can be written as 
%
\begin{equation}
\E \left( \left( f(x) \right) ^ 2 - 2 f(x) \E f(x) + \left( \E f(x) \right) ^ 2 \right) = \E \left( f(x) \right) ^ 2 - \left( \E f(x) \right) ^ 2.
\end{equation}
%
Therefore, 
%
\begin{equation}
\Var f(x) = \E \left( f(x) \right) ^ 2 - \left( \E f(x) \right) ^ 2.
\end{equation}
%
...
%
\begin{equation}
\E x y - \E \left( x \E y \right) - \E \left( y \E x \right) + \E \left( \E x \E y \right) = \E x y - \E x \E y.
\end{equation}
%
The right hand side can be written as
%
...
%
\begin{equation}
\E x = \int_{-\infty}^{\infty} x \mathcal{N} \left( x | \mu, \sigma ^ 2 \right) dx.
\end{equation}
%
...
= - \frac{1}{2} \left( \sigma ^ 2 \right) ^ {- 1} + \frac{1}{2} \left( \sigma ^ 2 \right) ^ {- 2} \Var x.
\end{aligned}
\end{equation}
%
Therefore,
...
%
\begin{equation}
\Var (x + y) = \E \left( x + y - \E (x + y) \right) ^ 2
\end{equation}
%
...
\begin{equation}
\begin{aligned}
\E \left( x - \E x \right) ^ 2 + 2 \E \left( \left( x - \E x \right) \left( y - \E y \right) \right) + \E \left( y - \E y \right) ^ 2 \\
...
%
\begin{equation}
\E x_n ^ 2 =  \Var x_n + \left( \E x_n \right) ^ 2.
\end{equation}
%
...
%
\begin{equation}
\E x_m x_n = \mu ^ 2 + \delta_{mn} \sigma ^ 2.
\end{equation}
%
...
%
\begin{equation}
\E \mu_{\rm ML} = \frac{1}{N} \sum_{n = 1}^{N} \E x_n.
\end{equation}
%
Therefore, 
%
...
%
\begin{equation}
\E \sigma_{\rm ML}^2 = \frac{1}{N} \sum_{n = 1}^{N} \E \left( x_n - \mu_{\rm ML} \right) ^ 2.
\end{equation}
%
The right hand side can be writen as 
%
\begin{equation}
\frac{1}{N} \sum_{n = 1}^{N} \E \left( x_n ^ 2 - 2 \mu_{\rm ML} x_n + \mu_{\rm ML} ^ 2 \right) = \frac{1}{N} \sum_{n = 1}^{N} \E x_n ^ 2 - \frac{2}{N} \E \left( \mu_{\rm ML} \left( \sum_{n = 1}^{N} x_n \right) \right) + \E \mu_{\rm ML} ^ 2.
\end{equation}
%
...
%
\begin{equation}
- 2 \E \mu_{\rm ML} ^ 2 + \E \mu_{\rm ML} ^ 2 = - \E \mu_{\rm ML} ^ 2.
\end{equation}
%
Here, 
%
\begin{equation}
\E \mu_{\rm ML} ^ 2 = \E \left( \frac{1}{N} \sum_{n = 1}^{N} x_n \right) ^ 2.
\end{equation}
%
The right hand side can be written as 
%
\begin{equation}
\frac{1}{N ^ 2} \sum_{n = 1}^{N} \E x_n ^ 2 + \frac{2}{N ^ 2} \sum_{1 \leq m < n \leq N} \E x_m x_n = \frac{1}{N} (\mu ^ 2 + \sigma ^ 2) + \frac{N - 1}{N} \mu ^ 2.
\end{equation}
%
Therefore,
%
\begin{equation}
\E \mu_{\rm ML} ^ 2 = \mu ^ 2 + \frac{1}{N} \sigma ^ 2.
\end{equation}
%
Thus,
%
\begin{equation}
\E \sigma_{\rm ML}^2 = \frac{N - 1}{N} \sigma ^ 2.
\end{equation}
%
...
%
\begin{equation}
\E \left( \frac{1}{N} \sum_{n = 1}^{N} \left( x_n - \mu \right) ^ 2 \right) = \frac{1}{N} \sum_{n = 1}^{N} \E \left( x_n - \mu \right) ^ 2.
\end{equation}
%
The right hand side can be writen as 
%
...
%
\begin{equation}
\E \left( \frac{1}{N} \sum_{n = 1}^{N} \left( x_n - \mu \right) ^ 2 \right) = \sigma ^2.
\end{equation}
%
...
%
\begin{equation}
\E L = \sum_{k} \sum_{j} \int_{\mathcal{R}_j} L_{kj} p(\mathbf{x}, \mathcal{C}_k) d\mathbf{x}.
\end{equation}
%
If
%
...
%
\begin{equation}
\E L = 1 - \sum_{j} \int_{\mathcal{R}_j} p(\mathcal{C}_j | \mathbf{x}) p(\mathbf{x}) d\mathbf{x}.
\end{equation}
%
...
%
\begin{equation}
\E L = \sum_{j} \int_{\mathcal{R}_j} \left( \sum_{k} L_{kj} p(\mathcal{C}_k | \mathbf{x}) \right) p(\mathbf{x}) d\mathbf{x}.
\end{equation}
%
Thus, mimising $\E L$ reduces to choosing to minimise $\sum_{k} L_{kj} p(\mathcal{C}_k | \mathbf{x})$.
...
%
\begin{equation}
\E L\left( \mathbf{t}, \mathbf{y} (\mathbf{x}) \right) = \int \int \lVert \mathbf{y}(\mathbf{x}) - \mathbf{t} \rVert ^ 2 p(\mathbf{x}, \mathbf{t}) d\mathbf{x} d\mathbf{t}.
\end{equation}
%
Then
%
\begin{equation}
\frac{\delta \E L\left( \mathbf{t}, \mathbf{y} (\mathbf{x}) \right)}{\delta \mathbf{y} (\mathbf{x})} = 2 \int \left( \mathbf{y} (\mathbf{x}) - \mathbf{t} \right) p(\mathbf{x}, \mathbf{t}) d\mathbf{t}.
\end{equation}
%
To minimise $\E L\left( \mathbf{t}, \mathbf{y} (\mathbf{x}) \right)$, setting the left hand side to zero gives
%
\begin{equation}
...
%
\begin{equation}
\mathbf{y}(\mathbf{x}) \int p(\mathbf{t} | \mathbf{x}) d\mathbf{t} - \int \mathbf{t} p(\mathbf{t} | \mathbf{x}) d\mathbf{t} = \mathbf{y}(\mathbf{x}) - \E_\mathbf{t} (\mathbf{t} | \mathbf{x}).
\end{equation}
%
Thus,
%
\begin{equation}
\mathbf{y}(\mathbf{x}) = \E_\mathbf{t} (\mathbf{t} | \mathbf{x}).
\end{equation}
%
...
%
\begin{equation}
\mathbf{y}(\mathbf{x}) = \E_t (t | \mathbf{x}).
\end{equation}
%
...
\begin{equation}
\begin{aligned}
&\int \int \lVert \mathbf{y}(\mathbf{x}) - \E_\mathbf{t} (\mathbf{t} | \mathbf{x}) + \E_\mathbf{t} (\mathbf{t} | \mathbf{x}) - \mathbf{t} \rVert ^ 2 p(\mathbf{x}, \mathbf{t}) d\mathbf{x} d\mathbf{t} \\ 
&= \int \int \lVert \mathbf{y}(\mathbf{x}) - \E_\mathbf{t} (\mathbf{t} | \mathbf{x}) \rVert ^ 2 p(\mathbf{x}, \mathbf{t}) d\mathbf{x} d\mathbf{t} \\
&+ 2 \int \int \left( \mathbf{y}(\mathbf{x}) - \E_\mathbf{t} (\mathbf{t} | \mathbf{x}) \right) ^ \intercal \left( \E_\mathbf{t} (\mathbf{t} | \mathbf{x}) - \mathbf{t} \right) p(\mathbf{x}, \mathbf{t}) d\mathbf{x} d\mathbf{t} \\
&+ \int \int \lVert \E_\mathbf{t} (\mathbf{t} | \mathbf{x}) - \mathbf{t} \rVert ^ 2 p(\mathbf{x}, \mathbf{t}) d\mathbf{x} d\mathbf{t}.
\end{aligned}
\end{equation}
%
...
%
\begin{equation}
\int \lVert \mathbf{y}(\mathbf{x}) - \E_\mathbf{t} (\mathbf{t} | \mathbf{x}) \rVert ^ 2 \left( \int p(\mathbf{x}, \mathbf{t}) d\mathbf{t} \right) d\mathbf{x} = \int \lVert \mathbf{y}(\mathbf{x}) - \E_\mathbf{t} (\mathbf{t} | \mathbf{x}) \rVert ^ 2 p(\mathbf{x}) d\mathbf{x}.
\end{equation}
%
The second term can be written as
%
\begin{equation}
2 \int \left( \mathbf{y}(\mathbf{x}) - \E_\mathbf{t} (\mathbf{t} | \mathbf{x}) \right) ^ \intercal \left( \int \left( \E_\mathbf{t} (\mathbf{t} | \mathbf{x}) - \mathbf{t} \right) p(\mathbf{t} | \mathbf{x}) d\mathbf{t} \right) p(\mathbf{x}) d\mathbf{x}.
\end{equation}
%
Since
%
...
%
\begin{equation}
\int \left( \int \lVert \E_\mathbf{t} (\mathbf{t} | \mathbf{x}) - \mathbf{t} \rVert ^ 2 p(\mathbf{t} | \mathbf{x}) d\mathbf{t} \right) p(\mathbf{x}) d\mathbf{x} = \int \Var_{\mathbf{t}} (\mathbf{t} | \mathbf{x}) p(\mathbf{x}) d\mathbf{x}.
\end{equation}
%
Therefore,
%
\begin{equation}
\E L\left( \mathbf{t}, \mathbf{y} (\mathbf{x}) \right) = \int \lVert \mathbf{y}(\mathbf{x}) - \E_\mathbf{t} (\mathbf{t} | \mathbf{x}) \rVert ^ 2 p(\mathbf{x}) d\mathbf{x} + \int \Var_{\mathbf{t}} (\mathbf{t} | \mathbf{x}) p(\mathbf{x}) d\mathbf{x}.
\end{equation}
%
Thus, $\E L\left( \mathbf{t}, \mathbf{y} (\mathbf{x}) \right)$ is mimimised if
%
\begin{equation}
\mathbf{y} (\mathbf{x}) = \E_\mathbf{t} (\mathbf{t} | \mathbf{x}).
\end{equation}
...
%
\begin{equation}
\E L_q = \int \int \abs{y(\mathbf{x}) - t} ^ q p(\mathbf{x}, t) d\mathbf{x} dt.
\end{equation}
%
Then
%
\begin{equation}
\frac{\delta \E L_q}{\delta y (\mathbf{x})} = \int q \abs{y(\mathbf{x}) - t} ^ {q - 1} {\rm sign} (y(\mathbf{x}) - t) p(\mathbf{x}, t) dt.
\end{equation}
%
To minimise $\E L_q$, setting the left hand side to zero gives
%
\begin{equation}
0 = \int \abs{y(\mathbf{x}) - t} ^ {q - 1} {\rm sign} (y(\mathbf{x}) - t) p(t | \mathbf{x}) dt.
\end{equation}
%
This is the condition that $y(\mathbf{x})$ must satisfy in order to minimise $\E L_q$.
...
%
\begin{equation}
\frac{\delta L(p(x))}{\delta p(x)} = - \ln p(x) - 1 + \lambda_1 + \lambda_2 x + \lambda_3 (x - \mu) ^ 2.
\end{equation}
%
