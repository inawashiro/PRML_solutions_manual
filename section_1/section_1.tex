...
\label{1.15}
Let $n(D, M)$ be the number of independent parameters of a polynomial where $D$ and $M$ are the dimensionality and order of the polynomial.
Then
%
\begin{equation}
n(1, M)
...
\end{equation}
%
Thus, the assumption is proved by the induction on $D$.
...
\end{equation}
%
Therefore, the assumption is proved by the induction on $D$.
...
\end{equation}
%
Therefore, the assumption is proved by the induction on $M$.
